...
class SolidFreeCadWorkbenchActivityV25 : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent { MyApplicationTheme { V25Workbench(initialUri) { cadSurface = it } } }
    }
...
@Composable
private fun V25Workbench(initialUri: Uri?, onSurfaceReady: (FaceDrivenCadSurfaceViewV25) -> Unit) {
