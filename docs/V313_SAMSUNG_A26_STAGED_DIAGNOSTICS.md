...
Synchronization trigger: staged diagnostic build after all probe sources and manifest generation are present. This branch and its temporary build PR must not be merged into main.
